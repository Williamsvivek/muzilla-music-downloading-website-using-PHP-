...
$q="insert into feedback(rate,request,cat,suggestion,name) values('$rate','$request','$cat','$sugg','$name')";
        	...
        	<div id="new_released_section">
           	  ...
           	  <form id="form1" name="form1" method="post" action="">
           	    <table width="100%" border="0">
           	      <tr>
           	        <td width="28%" align="left" class="tabledata">How Will You Rate Our Website</td>
           	        <td width="72%" align="left"><label for="rate"></label>
           	      ...
           	      <tr>
           	        <td align="left" class="tabledata">Any Song Request?</td>
           	        <td align="left"><label for="request"></label>
       	            <input type="text" name="request" id="request" /></td>
       	          </tr>
           	      <tr>
           	        <td align="left" class="tabledata">Do You Want Any Additional Category?</td>
           	        <td align="left"><input type="text" name="cat" id="cat" /></td>
       	          </tr>
           	      <tr>
           	        <td align="left" class="tabledata">Any Suggestions?</td>
           	        <td align="left"><label for="suggestion"></label>
       	            <textarea name="suggestion" id="suggestion" cols="45" rows="5"></textarea></td>
       	          </tr>
           	      <tr>

              ...
              <table width="100%" border="0">
           	    <tr>
           	      <td>
           	        <table width="100%" border="0">
           	          <tr>
           	            <td width="24%" align="left">Enter Name To Search</td>
           	            <td width="76%" align="left"><input type="text" name="name" id="name" /></td>
       	              </tr>
           	          <tr>
           	            <td>&nbsp;</td>
           	            <td align="left"><input type="submit" name="submit" id="submit" value="search" /></td>
       	              </tr>
           	          <tr>
           	            <td>&nbsp;</td>
           	            <td>
...
$query="select * from addsubcat where subcatname like '%$nm%'";
...
else
{
	...
	while($x=mysqli_fetch_array($res))
	{
		...
		print"<td>$x[1]</td>";
		print "<td><a href='showproducts.php?scid=$x[3]'>View</a></td>";
	
		print"<tr>";
	}
	print"</table>";
	print"$cnt Albums available";
}
}
?>
                        </td>

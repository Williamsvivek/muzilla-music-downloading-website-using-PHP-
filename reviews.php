...
$q="insert into review(name,email,review) values('$name','$email','$review')";
mysqli_query($conn,$q) or die("Error in Query".mysqli_error($conn));
$cnt=mysqli_affected_rows($conn);
mysqli_close($conn);
if($cnt==1)
{
	$msg="Thanks...For Your Valuable Review";
}
else
{
	$msg="Error";
        	...
        	<div id="new_released_section">
           	  ...
           	  <form id="form1" name="form1" method="post" action="">
           	    <table width="100%" border="0">
           	      ...
           	      <tr>
           	        <td align="left" class="tabledata">Reviews</td>
           	        <td align="left"><textarea name="review" id="review" cols="45" rows="5"></textarea></td>
       	          </tr>
           	      <tr>
           	        <td colspan="2" align="center" class="tabledata"><input type="submit" name="submit" id="submit" value="Submit" />
       	            <input type="reset" name="reset" id="reset" value="Reset" /></td>
       	          </tr>
           	      <tr>
           	        <td colspan="2" align="center" class="tabledata"><label for="review">
           	          <?php
					if(isset($_POST["submit"]))
{
	print $msg;
